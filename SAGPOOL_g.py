...
#from GCNConv_sagpool import SAGPool
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.pool = SAGPool(nhid*3, ratio=min_nodes)
...
f = open(os.path.join('./data',args.dataname,args.mode+'_sagpool_global_REAL_REAL_result.csv'), 'a', encoding='utf-8', newline='')
wr = csv.writer(f)

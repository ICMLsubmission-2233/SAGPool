...
from topk_global import topk_pool
...
class Net(torch.nn.Module):
    def __init__(self):
        ...
        self.pool = topk_pool(nhid*3, min_nodes)
...
f = open(os.path.join('./data',args.dataname,args.mode+'_topk_global_result.csv'), 'a', encoding='utf-8', newline='')
wr = csv.writer(f)
